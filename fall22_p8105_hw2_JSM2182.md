...
glass bottles, trash bottles) by weight (in tons), across
`nrow(r combo_wheels_tidy %>% distinct(year))`years (2014 - 2021). This
is helpful for generating summary stats on output and can help compare
efficacy between mr. trashwheels and professor trash wheels. For
example, In the year 2020, Mr. Trashwheels collected 72 sports balls.
