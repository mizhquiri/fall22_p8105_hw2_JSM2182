...
numeric variable \* sports_ball is rounded/set to an integer \* note
that year has been changed to an integer \* a variable “wheel” with
value of “mr” has been applied to all obs, to facilitate tracking after
merging.

*Professor Trashwheel dataset* \* variable names are cleaned \* rows not
containing dumpster values are removed \* a variable “wheel” with value
of “prof” has been applied to all obs, to facilitate tracking and later
merging \* note that sports balls is NOT included as a variable \* note
that dumpster variable is a numeric variable
